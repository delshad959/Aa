...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "farabi") || (event.body.toLowerCase() == "ফারাবি") || (event.body.toLowerCase() == "@হা্ঁসি্ঁর্ঁ রা্ঁজা্ঁッ") || (event.body.toLowerCase() == "ফারাবি ভাই")) {
   ...
   if ((event.body.toLowerCase() == "তোর বস কে") || (event.body.toLowerCase() == "তোর এডমিন কে ")) {
     return api.sendMessage("My Creator:farabi ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস ফারাবি আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "বটের এডমিন")) {
     return api.sendMessage("He is farabi ッ❤️ তাকে সবাই ফারাবি নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "শালা আমি ফারাবি") || (event.body.toLowerCase() == "আমি তোর বস") || (event.body.toLowerCase() == "চুপ শালা")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@অজানা কুইন") || (event.body.toLowerCase() == "@অজানা কুইন ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস ফারাবি এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "বট চুনা") || (event.body.toLowerCase() == "বট চুনা💋")) {
     return api.sendMessage("জান বলো তোমার অলিতে গলিতে💋 উম্মাহ..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "তুই পাগল ছাগল") || (event.body.toLowerCase() == "পাগল")) {
     return api.sendMessage("তোর চৌদ্দ গুষ্টি পাগল ছাগল হালা তার ছিড়া চুপ..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@বউ পাগলা ") || (event.body.toLowerCase() == "অন্তর")) {
     return api.sendMessage("🥰-অন্তর মুরগি চোর-🌺 আমার বস ফারাবি'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };

   if ((event.body.toLowerCase() == "KISS ME") || (event.body.toLowerCase() == "উম্মাহ💋")) {
   ...
   if ((event.body.toLowerCase() == "নাম কি তোর") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝗜𝘀𝗹𝗮𝗺𝗶𝗰𝗸 𝗰𝗵𝗮𝘁 𝗯𝗼𝘁 farabi", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😏") || (event.body.toLowerCase() == "ex")) {
     return api.sendMessage("️উফ🥵কামান বেবি🫦💋কিস দিয়ে মুখ সোজা করে দিবো🫦 🥵", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "বট তুমি আমাকে ভালোবাসো না") || (event.body.toLowerCase() == "আজ কেউ নাই বলে") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     return api.sendMessage("️চিন্তা করো কেন আমি তো আছি🫶/nতোমাকে রাইতে ভালোবাসবো", threadID);
   };

   if ((event.body.toLowerCase() == "বট একটা জামাই দে") || (event.body.toLowerCase() == "বট একটা বউ দে")) {
     return api.sendMessage("দূর হ ফকিরের দল তোদের কপালে বিয়ে নাই<🥺", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "আই লাভ ইউ") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("সব মুতার জায়গায় গুঁতা দেওয়ার ধান্দা 😪🥱", threadID);
   };

     if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "Bye") || (event.body.toLowerCase() == "jaiga") || (event.body.toLowerCase() == "বাই") || (event.body.toLowerCase() == "pore kotha hbe") || (event.body.toLowerCase() == "যাইগা")) {
   ...
   if ((event.body.toLowerCase() == "tumi ki amake bhalobaso") || (event.body.toLowerCase() == "বট তুমি আমাকে ভালোবাসো")) {
